  ...
  render() {
    return(
      <div id="main">
		...
		<h3>Harness</h3>
		<img className="alignright" src="https://wsrv.nl/?url=gdichicago.com/courses/intro-html-css/sample-code/final/img/emptyharness.jpg" alt="A rock climbing harness" />
		...
		<h3>Shoes</h3>
		<img className="alignright" src="https://wsrv.nl/?url=gdichicago.com/courses/intro-html-css/sample-code/final/img/shoes.jpg" alt="A rock climbing shoe" />
		...
		<h3>Belay Device</h3>
		<img className="alignright" src="https://wsrv.nl/?url=gdichicago.com/courses/intro-html-css/sample-code/final/img/atc-xp.jpg" alt="An ATC-style belay device" />
		<p>A belay device is a small mechanism that is used to connect a climber and their belayer. Some can also be used to rappel. A belay device serves a few primary purposes:</p>
		<ol>
		...
		<img className="alignright" src="https://wsrv.nl/?url=gdichicago.com/courses/intro-html-css/sample-code/final/img/chalk-carabiner.jpg" alt="A chalk bag and a carabiner" />
		...
		<h3>Helmet</h3>
		<img className="alignright" src="https://wsrv.nl/?url=gdichicago.com/courses/intro-html-css/sample-code/final/img/helmet.jpg" alt="A climbing helmet" />
