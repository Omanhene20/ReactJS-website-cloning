...
class Types extends Component {
  render() {
    return(
      ...
      <img className="alignleft" src="https://wsrv.nl/?url=gdichicago.com/courses/intro-html-css/sample-code/final/img/indoor-climbing.jpg" alt="A rock climbing wall in a gym" />
